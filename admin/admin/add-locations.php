...
$query=mysqli_query($con,"insert into tbllocations(location_name) values('$location_name')");
if($query){
echo "<script>alert('New Location Added Successfully.');</script>";
echo "<script type='text/javascript'> document.location = 'manage-locations.php'; </script>";
} else {
...
<head>
  ...
  <title>AgroLink | Add Location</title>
...
<!-- Username-->
    <div class="form-group">
                    <label for="exampleInputusername">Enter New Location</label>
               <input type="text" placeholder="Enter City"  name="location_name" id="location_name" class="form-control" title="Enter Location" onBlur="checkAvailability()"  required>
