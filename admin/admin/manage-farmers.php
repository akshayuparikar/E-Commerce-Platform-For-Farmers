...
if($query){
echo "<script>alert('Farmer Record Deleted Successfully.');</script>";
...
<head>
  ...
  <title>AgroLink | Manage Farmers</title>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
<?php $query=mysqli_query($con,"SELECT tblfarmer.*, tbllocations.*, tbllocations.location_name AS l_location_name, tblfarmer.id AS f_id 
FROM tblfarmer 
JOIN tbllocations ON tbllocations.id = tblfarmer.location_id
");
$cnt=1;
...
?>
                  ...
                  <tr>
                   ...
                   <td><?php echo $result['mobno']?></td>
                    ...
                    <th>
     <a href="manage-farmers.php?action=delete&&id=<?php echo $result['f_id']; ?>" style="color:red;" title="Delete this record" onclick="return confirm('Do you really want to delete this record?');"><i class="fa fa-trash" aria-hidden="true"></i> </a></th>
                  </tr>
         <?php } ?>
