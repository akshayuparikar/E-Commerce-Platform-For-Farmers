...
$query=mysqli_query($con,"delete from tbllocations where id ='$location_id'");
if($query){
...
<head>
  ...
  <title>AgroLink | Manage Locations</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Manage City List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
?>
                  ...
                  <td> <a href="manage-locations.php?action=delete&&id=<?php echo $result['id']; ?>" title="Delete this Record" onclick="return confirm('Do you really want to delete this record?');">
